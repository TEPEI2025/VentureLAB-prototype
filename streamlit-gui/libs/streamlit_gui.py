...
class StreamlitGUI: 
    ...
    @st.dialog("VentureVox Guide", width='large')
    ...
    def display_quit_interview_button(self) -> None: 
        ...
        if st.session_state.interview_status: 
            ...
            with st.sidebar: 
                st.markdown("To end the VentureVox, click quit below")
    ...
    def on_quit_button(self) -> None: 
        ...
        self.save_msg_to_session('assistant', "You have cancelled the VentureVox.")
